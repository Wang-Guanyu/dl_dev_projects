...
#
#    conv4 = Conv2D(256, (3, 3), activation='tanh', padding='same')(pool3)
#    conv4 = Conv2D(256, (3, 3), activation='tanh', padding='same')(conv4)
#    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4)
#
#    conv5 = Conv2D(512, (3, 3), activation='tanh', padding='same')(pool4)
#    conv5 = Conv2D(512, (3, 3), activation='tanh', padding='same')(conv5)
#
#    up6 = concatenate([Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same')(conv5), conv4], axis=3)
#    conv6 = Conv2D(256, (3, 3), activation='tanh', padding='same')(up6)
#    conv6 = Conv2D(256, (3, 3), activation='tanh', padding='same')(conv6)
#
#    up7 = concatenate([Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same')(conv6), conv3], axis=3)
#    conv7 = Conv2D(128, (3, 3), activation='tanh', padding='same')(up7)
#    conv7 = Conv2D(128, (3, 3), activation='tanh', padding='same')(conv7)
#
...
#    model = Model(inputs=[inputs], outputs=[conv10])
    ...
    conv10 = Conv2D(1, (1, 1), activation='sigmoid')(conv5)
...
#    imgs_test /= std
    ...
    for image, image_id in zip(imgs_mask_test, imgs_id_test):
        ...
        filename = 'preds/' + str(image_id) + '_pred.png'
